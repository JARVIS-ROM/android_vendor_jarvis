...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/jarvis/sounds/pixel/,$(TARGET_COPY_OUT_PRODUCT)/media/audio)

# 2019 Material product sounds (CC-BY 4.0)
# Source: https://material.io/design/sound/sound-resources.html
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/jarvis/sounds/material/,$(TARGET_COPY_OUT_PRODUCT)/media/audio)
